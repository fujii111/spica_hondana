...
class GenresControllerTest < ActionController::TestCase
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post :create, genre: { delete_flg: @genre.delete_flg, description: @genre.description, name: @genre.name, sort: @genre.sort }
    end
  ...
  test "should update genre" do
    patch :update, id: @genre, genre: { delete_flg: @genre.delete_flg, description: @genre.description, name: @genre.name, sort: @genre.sort }
    assert_redirected_to genre_path(assigns(:genre))
  end
